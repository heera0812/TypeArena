...
export default function LandingPage() {
  return (
    <div className="relative flex flex-col min-h-[85vh] w-full items-center justify-center text-center px-4 py-12 overflow-hidden bg-gradient-to-b from-[#f4f8fc] via-[#e9f2fc] to-[#f4f8fc]">
      ...
      <div
        className="space-y-10 max-w-4xl relative z-10 w-full animate-slide-up"
      >
        {/* Branding & Headline */}
        ...
        {/* Stats Pill Card */}
        <div className="max-w-2xl mx-auto w-full animate-slide-up delay-200">
        ...
        {/* Game Mode Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2 animate-slide-up delay-300">
          {/* Race Mode */}
        ...
        <div className="max-w-4xl mx-auto w-full pt-2 animate-slide-up delay-400">
